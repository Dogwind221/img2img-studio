...
Options:
  ...
  --provider <name>    Provider for direct-api batch tasks (default: replicate)
  --model <id>         Explicit model for direct-api batch tasks (default: resolved by direct-api config/env)
